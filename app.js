...
const SCORE_TO_MONTHS = {
  ...
  7: 24, 8: 30, 9: 36, 10: 42, 11: 48, 12: 60, 13: 72
};
...
function renderDeviationCharts(data) {
  ...
  const relativeDpuBox = document.createElement("div");
  relativeDpuBox.className = "chart";
  const relativeDpuTitle = document.createElement("div");
  relativeDpuTitle.className = "scale-chart-title";
  relativeDpuTitle.textContent = "Relativ total afvigelse pr. DPU (%)";
  relativeDpuBox.appendChild(relativeDpuTitle);
  const relativeDpuHost = document.createElement("div");
  relativeDpuBox.appendChild(relativeDpuHost);
